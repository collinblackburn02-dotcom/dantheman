...
if st.session_state.app_state == "onboarding":
    ...
    st.markdown("<h2 style='text-align: center; font-size: 1.5rem; color: #444;'>Identity Resolution Engine</h2>", unsafe_allow_html=True)
...
# ================ 4. STATE 2: LIVE DASHBOARD =================
    ...
    st.markdown(f"<h1 style='color: {PITCH_BRAND_COLOR} !important;'>🧬 Identity Match Dashboard</h1>", unsafe_allow_html=True)
    ...
    m1, m2 = st.columns(2)
    m1.metric("Resolved Profiles", f"{total_buyers:,.0f}")
