...
# Resolve Net worth according to new CSV header
...
# Fallbacks if a different header is used
if state_col is None:
    candidate_names = [
        "PERSONAL_STATE", "STATE", "US_STATE", "STATE_CODE", "STATE_ABBR"
    ]
